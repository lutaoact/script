...
# 构建centos开发环境，基于如下版本：
# lsb_release -a #执行此命令，可以查看版本信息#sudo yum install redhat-lsb-core
...
echo 'ddxd2015' | sudo -S ln -sf /home/centos/some_config/vimrc /root/.vimrc
